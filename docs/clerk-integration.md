...
> _Adopted from podrecorder.net (pinned commit `06b07b8`) as the reference playbook for Caption Guru's paid-features work — see ROADMAP "Auth + billing". Verbatim; provenance note added on import._
